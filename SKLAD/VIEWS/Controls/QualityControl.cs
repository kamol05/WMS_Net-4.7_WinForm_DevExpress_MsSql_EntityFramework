...
{
    public partial class Sifatlar : UserControl
    {
        ...
        public Sifatlar()
        {
            ...
            dbContext.Quality.LoadAsync().ContinueWith(loadTask =>
            {
                gridControl1.DataSource = dbContext.Quality.Local.ToBindingList();
        ...
        {
            var quality = (Quality)e.Row;
            dbContext.SaveChanges();
            Logger.Log("Quality:", quality.ToString());
        }
