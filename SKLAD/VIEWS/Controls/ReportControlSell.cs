...
{
    public partial class Mahsulotlar_Sotilgan : UserControl
    {
        public Mahsulotlar_Sotilgan()
        {
            InitializeComponent();
            ...
            dbContext.SaleEvent.LoadAsync().ContinueWith(loadTask =>
            {
                // Bind data to control when loading complete
                pivotGridControl1.DataSource = dbContext.SaleEvent.AsNoTracking().ToList();
            }, System.Threading.Tasks.TaskScheduler.FromCurrentSynchronizationContext());

            using (var db = new EFcontext())
            {
                lookUpEdit1.Properties.DataSource = db.ReportLayout.Where(o => o.Type == ReportLayout.ReportLayoutType.Sell).ToList();
            }

            //fieldDate.ValueFormat.FormatType = DevExpress.Utils.FormatType.DateTime;
        ...
        private void saqlash_Click(object sender, System.EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(form.name))
            {
                ...
                var rl = new ReportLayout { Id = 0, Name = form.name, Type = ReportLayout.ReportLayoutType.Sell, Data = layout.ToArray() };
                using (var db = new EFcontext())
                {
                    ...
                    db.SaveChanges();
                    Logger.Log("Sell Report", rl.ToString2());
                    lookUpEdit1.Properties.DataSource = db.ReportLayout.Where(o => o.Type == ReportLayout.ReportLayoutType.Sell).ToList();
                }
            }
        }
