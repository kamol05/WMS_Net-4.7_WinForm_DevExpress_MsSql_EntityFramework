...
{
    public partial class Paletlar : UserControl
    {
        public Paletlar()
        {
            InitializeComponent();
            ...
            dbContext.Palette.LoadAsync().ContinueWith(loadTask =>
            {
                // Bind data to control when loading complete
                gridControl1.DataSource = dbContext.Palette.Local.ToBindingList();
            }, System.Threading.Tasks.TaskScheduler.FromCurrentSynchronizationContext());

            gridView1.RowUpdated += gridView1_RowUpdated;
            gridView1.NewItemRowText = "Yangi Palet Kiritish uchun bu yerga bosing";
        ...
        {
            var palette = (Palette)e.Row;
            dbContext.SaveChanges();
            Logger.Log("Palette:", palette.ToString2());
        }
