...
{
    public partial class Ishchilar : UserControl
    {
        ...
        public Ishchilar()
        {
            ...
            dbContext.User.LoadAsync().ContinueWith(loadTask =>
            {
                // Bind data to control when loading complete
                gridControl1.DataSource = dbContext.User.Local.ToBindingList();
            }, System.Threading.Tasks.TaskScheduler.FromCurrentSynchronizationContext());
            gridView1.RowUpdated += gridView1_RowUpdated;
            gridView1.NewItemRowText = "Yangi User Kiritish uchun bu yerga bosing";
