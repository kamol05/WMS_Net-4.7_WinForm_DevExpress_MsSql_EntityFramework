...
{
    public partial class Skladlar : UserControl
    {
        ...
        public Skladlar()
        {
            ...
            {
                gridControl1.DataSource = dbContext.Warehouse.Local.ToBindingList();
            }, System.Threading.Tasks.TaskScheduler.FromCurrentSynchronizationContext());

            gridView1.RowUpdated += gridView1_RowUpdated;
            gridView1.NewItemRowText = "Yangi Sklad kiritish uchun bu yerga bosing";
            gridView1.PopupMenuShowing += gridView1_PopupMenuShowing;
        }

        private void gridView1_RowUpdated(object sender, DevExpress.XtraGrid.Views.Base.RowObjectEventArgs e)
        {
            var warehouse = (Warehouse)e.Row;
            dbContext.SaveChanges();
            Logger.Log("Warehouse:", warehouse.ToString());
        }
