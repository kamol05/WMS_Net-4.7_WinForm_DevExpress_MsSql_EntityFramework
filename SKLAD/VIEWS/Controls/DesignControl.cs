...
{
    public partial class Dizaynlar : UserControl
    {
        ...
        public Dizaynlar()
        {
            ...
            dbContext.Design.LoadAsync().ContinueWith(loadTask =>
            {
                gridControl1.DataSource = dbContext.Design.Local.ToBindingList();
            }, System.Threading.Tasks.TaskScheduler.FromCurrentSynchronizationContext());
            gridView1.RowUpdated += gridView1_RowUpdated;
            gridView1.NewItemRowText = "Yangi Dizayn Kiritish uchun bu yerga bosing";
            gridView1.PopupMenuShowing += gridView1_PopupMenuShowing;
        }

        private void gridView1_RowUpdated(object sender, DevExpress.XtraGrid.Views.Base.RowObjectEventArgs e)
        {
            var design = (Design)e.Row;
            dbContext.SaveChanges();
            Logger.Log("Design:", design.ToString());
        }
